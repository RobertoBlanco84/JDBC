...
public class Queries {
	...
	public String insertDog() {
		String insertQuery = "INSERT INTO Dog ("+ javaBean.getDogList().get(0) + ", " +
				javaBean.getDogList().get(1) + ", " + javaBean.getDogList().get(2) +
				", " + javaBean.getDogList().get(3) + " ," 
				+ javaBean.getDogList().get(4) + ") VALUES (?,?,?,?,?)";
		return insertQuery;
	}
